...
public class JPanelTang2 extends javax.swing.JPanel {
    ...
    public JButton timButtonByMaBan(String maBan) {
        switch (maBan) {
            case "T2B01":
                return btnban1;
            case "T2B02":
